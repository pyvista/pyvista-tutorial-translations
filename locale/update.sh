...
sphinx-build -T -b gettext ../pyvista-tutorial/doc pot || true  # will fail on VTK9
sphinx-build -T -b gettext ../pyvista-tutorial/doc pot || true  # need it again due to all our docstring examples
sphinx-build -T -b gettext ../pyvista-tutorial/doc pot
