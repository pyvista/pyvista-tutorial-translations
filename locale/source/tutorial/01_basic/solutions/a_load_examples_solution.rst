...
.. raw:: html
    ...
    </style><pre class='pv-text-repr-fallback'>PolyData (0x7f4dd934f460)
      N Cells:    351536
      N Points:   178091
      N Strips:   0
    ...
    </span></div><div class='pv-metadata'><div class='pv-meta-row pv-copyable'><span class='pv-meta-row-label'>Bounds</span><button class='pv-copy-btn' title='Copy to clipboard' data-copy='(2.7415754795074463, 78.46798706054688, 0.0, 79.6875, 0.0, 99.609375)' onclick="navigator.clipboard.writeText(this.dataset.copy)">⧉</button><span class='pv-meta-entry'><span class='pv-meta-label'>X</span> [2.742e+00, 7.847e+01]</span><span class='pv-meta-entry'><span class='pv-meta-label'>Y</span> [0.000e+00, 7.969e+01]</span><span class='pv-meta-entry'><span class='pv-meta-label'>Z</span> [0.000e+00, 9.961e+01]</span></div><div class='pv-meta-row pv-copyable'><span class='pv-meta-row-label'>Cells</span><span class='pv-meta-entry'><span class='pv-meta-label'>faces</span> 351,536</span></div></div><ul class='pv-sections'><li class='pv-section-item'><input id='section-bb65f533-c118-4dc9-b193-398969442906' class='pv-section-summary-in' type='checkbox' checked /><label for='section-bb65f533-c118-4dc9-b193-398969442906' class='pv-section-summary' title='Expand/collapse section'>Point Data: <span>(1)</span></label><div class='pv-section-inline-details'></div><div class='pv-section-details'><ul class='pv-var-list'><li class='pv-var-item'><div class='pv-var-name'><span>Unnamed_0</span><button class='pv-copy-btn' title='Copy to clipboard' data-copy='Unnamed_0' onclick="navigator.clipboard.writeText(this.dataset.copy)">⧉</button></div><div class='pv-var-dims'>3 comp</div><div class='pv-var-dtype'>float32</div><div class='pv-var-range'>[-1.000e+00, 1.000e+00]</div><div class='pv-var-badges'> <span class='pv-badge pv-badge-normals'>normals</span></div></li></ul></div></li></ul></div></div>
    </div>
    <br />
    <br />
...
.. raw:: html
    ...
    </style><pre class='pv-text-repr-fallback'>MultiBlock (0x7f4dd934e1a0)
      N Blocks:   2
    ...
    </span></div><div class='pv-metadata'><div class='pv-meta-row pv-copyable'><span class='pv-meta-row-label'>Bounds</span><button class='pv-copy-btn' title='Copy to clipboard' data-copy='(0.0, 69.0, 0.0, 122.0, 0.0, 65.0)' onclick="navigator.clipboard.writeText(this.dataset.copy)">⧉</button><span class='pv-meta-entry'><span class='pv-meta-label'>X</span> [0.000e+00, 6.900e+01]</span><span class='pv-meta-entry'><span class='pv-meta-label'>Y</span> [0.000e+00, 1.220e+02]</span><span class='pv-meta-entry'><span class='pv-meta-label'>Z</span> [0.000e+00, 6.500e+01]</span></div></div><ul class='pv-sections'><li class='pv-section-item'><input id='section-2e5aeb26-ddd4-49ab-91ee-c28edb380ac0' class='pv-section-summary-in' type='checkbox' checked /><label for='section-2e5aeb26-ddd4-49ab-91ee-c28edb380ac0' class='pv-section-summary' title='Expand/collapse section'>Blocks: <span>(2)</span></label><div class='pv-section-inline-details'></div><div class='pv-section-details'><ul class='pv-children-list'><li><span class='pv-child-name'>bolt</span><span class='pv-child-type'>ImageData</span><span class='pv-child-detail'>568,260 pts · 547,170 cells · 555 KiB</span></li><li><span class='pv-child-name'>nut</span><span class='pv-child-type'>ImageData</span><span class='pv-child-detail'>164,492 pts · 155,440 cells · 161 KiB</span></li></ul></div></li></ul></div></div>
    </div>
    <br />
    <br />
